...
static uint8_t iteration_shift[] = {
...
uint64_t des(uint64_t input, uint64_t key, uint8_t mode)
{
    ...
    for (i = 0; i < 16; i++)
    {
        ...
        for (j = 0; j < 8; j++)
        {
            ...
            row = (uint8_t)((s_input & (0x0000840000000000 >> 6 * j)) >> 42 - 6 * j);
            row = (row >> 4) | row & 0x01;

            column = (uint8_t)((s_input & (0x0000780000000000 >> 6 * j)) >> 43 - 6 * j);
...
void CommonDesEcb(uint8_t* data_p, uint16_t data_len, uint8_t* key_p, uint8_t mode)
{
    uint64_t data_in =  ((uint64_t)data_p[0] << 56) +
                        ((uint64_t)data_p[1] << 48) +
                        ((uint64_t)data_p[2] << 40) +
                        ((uint64_t)data_p[3] << 32) +
                        ((uint64_t)data_p[4] << 24) +
                        ((uint64_t)data_p[5] << 16) +
                        ((uint64_t)data_p[6] << 8) +
                        ((uint64_t)data_p[7]);
    uint64_t key_in =   ((uint64_t)key_p[0] << 56) +
                        ((uint64_t)key_p[1] << 48) +
                        ((uint64_t)key_p[2] << 40) +
                        ((uint64_t)key_p[3] << 32) +
                        ((uint64_t)key_p[4] << 24) +
                        ...
                        ((uint64_t)key_p[7]);
    uint64_t data_out;
    data_out = des(data_in,key_in,mode);
